...
const questions = [
  ...
  {
    part: 1,
    question: "Q8 — Assets & Liabilities\nAsset = something valuable that the business owns or controls and can use in the business. (e.g. cash, laptop, vehicle)\nLiability = an amount that the business owes to others. (e.g. bank loan, amount owed to a supplier)\n\nQuestion:\nA business buys a laptop using a bank loan. Which statement is correct?",
    options: [
